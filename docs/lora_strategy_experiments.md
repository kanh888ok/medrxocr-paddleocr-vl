...
公开 1115 张词图上，LoRA 和轻增强都带来了可见提升：

| 对比 | Exact Match 变化 | Mean CER 变化 | Micro CER 变化 |
|---|---:|---:|---:|
| LoRA rank8 step512 相比基线 | +2.96 个百分点 | -4.96 个百分点 | -4.72 个百分点 |
| aug-light 相比 LoRA rank8 step512 | +1.43 个百分点 | -0.77 个百分点 | -0.81 个百分点 |
| aug-light 相比基线 | +4.39 个百分点 | -5.73 个百分点 | -5.53 个百分点 |

按 Micro CER 看，`aug-light rank8 step512` 相比 PaddleOCR-VL 基线下降约 13.0%。这说明主要收益先来自 LoRA 适配，轻增强再带来一小段增益。
